...
export default function CnameLookup(props) {
    ...
    async function fetchDNSData(domain, recordType) {
        ...
        const apiUrl = `https://dns.google/resolve?name=${domain}&type=5`;
  ...
  <span className="">CNAME Lookup</span>
</button>
}            
                                <br />
...
CnameLookup.defaultProps = {
    purpose: "CNAME Lookup",
    regex: "www.example.com",
    sample_text: "Canonical Name details goes here...",
}

// addPropertyControls(CnameLookup, {
