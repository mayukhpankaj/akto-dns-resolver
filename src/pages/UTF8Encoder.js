                    ...
                    >
                        ...
                        <div className="Polaris-Connected">
                            ...
                            <div className="Polaris-TextField Polaris-TextField--hasValue Polaris-TextField--multiline" style={{position: 'relative'}}>
                                ...
                                multiline="true"  value={inputValue} onChange={handleInputChange} placeholder="Please enter string here" className="Polaris-TextField__Input  " spellCheck="false" type="text" rows="4"   style={styles.textboxborder}> </textarea>
